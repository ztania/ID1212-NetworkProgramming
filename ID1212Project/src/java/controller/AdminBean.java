...
/**
 * Contains application logic to handle the administration of the Online shop.
 */
@Stateless
@LocalBean
public class AdminBean {
    ...
    public void initArticles() {
        em.merge(new Article("Item A", 10));
        em.merge(new Article("Item B", 20));
        em.merge(new Article("Item C", 30));
    }
