...
public class Connect {
	...
	public void sendInitialMessage(String connectMessage) {
		toServer.println(connectMessage);
	}
	
	public void sendWordGuess(String word) {
		toServer.println(word);
	}
	
	public void sendLetterGuess(char letter) {
		toServer.println(letter);
	}
